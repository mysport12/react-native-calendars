...
type Props = {
    ...
    selectedDay: React.ElementRef<typeof XDate>,
    topDay: React.ElementRef<typeof XDate>,
    refreshControl: React.Element,
    refreshing: boolean,
    onRefresh: Function
}

class ReactComp extends React.Component<Props> {
    ...
    componentDidUpdate(prevProps) {
        if (!dateutils.sameDate(this.props.topDay, prevProps.topDay)) {
            this.setState(
                {
                    reservations: []
                },
